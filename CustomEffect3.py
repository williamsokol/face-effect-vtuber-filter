...
while cap.isOpened():
    ...
    if face_results.multi_face_landmarks:
        for face_landmarks in face_results.multi_face_landmarks:
            eyebrow_style = mp_drawing.DrawingSpec(color=(0, 0, 0), thickness=2, circle_radius=1)  # Yellow
            eye_style = mp_drawing.DrawingSpec(color=(0, 0, 0), thickness=2, circle_radius=10)  # Cyan
